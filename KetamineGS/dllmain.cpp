...
void ProcessEventHook(UObject* Object, UFunction* Function, void* Params) {
    ...
    if (strstr(FuncNameW, "HandleStartingNewPlayer")) {
        ...
        auto Pawn = Globals::GameplayStatics->BeginDeferredActorSpawnFromClass(Globals::World, AMrKrabsBP_C::StaticClass(), a, ESpawnActorCollisionHandlingMethod::AlwaysSpawn, LOLController);
        ...
        LOLController->ReceivePossess(newPlayerPawn);
        LOLController->ReceiveBeginPlay();
